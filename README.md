...
[![Version](https://img.shields.io/badge/version-1.11.0-brightgreen)](#-status)
...
**1.11.0** — stable on macOS 14.2+ / Apple Silicon. The app now has shared navigation with back/forward history, visible recovery when a recording helper exits unexpectedly, consistent in-app confirmation dialogs and SVG icons, and clearer export requirements. The full local recording and processing pipeline remains unchanged.
